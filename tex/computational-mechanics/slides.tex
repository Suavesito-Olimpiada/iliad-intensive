...
% 3. Compare the two fields using the original macrostate and predictive-state graphics.
\begin{frame}{What is Computational Mechanics?}
  \begingroup\small
  \keyterm{Statistical Mechanics} makes predictions about the behaviour of
  systems by considering their \keyterm{statistical} properties:\par\endgroup
  \vspace{-1mm}
  \begin{center}\evidenceimage[17mm]{statmech-reference}\end{center}
  \vspace{-2mm}
  {\small
  \keyterm{Computational Mechanics} makes predictions about the behaviour of
  systems by considering their \keyterm{computational} properties:\par}
  \vspace{-1mm}
  \begin{center}\evidenceimage[20mm]{compmech-reference}\end{center}
\end{frame}
...
\begin{frame}{Central questions}
  ...
  \begin{itemize}
    ...
    \item How much of the past does a system store?
    \item How does the system store this information?
    \item How does this information affect system behaviour?
  \end{itemize}
  \vspace{4mm}
  ...
  {\centering
    ...
    \fcolorbox{iliadAccent}{iliadAccent!6}{%
      \parbox{0.88\textwidth}{\centering
        What are convergent structures relevant for \textbf{optimal prediction}?}}
    \par}
  \vspace{5mm}
...
\begin{frame}{The research program}
  ...
  ($\sim$2.5 years). There is much to do!
  ...
  \begin{itemize}
    ...
    \item For what classes of data generating \keyterm{processes} do we
      understand optimal prediction?
    \item For what scale of \keyterm{neural networks} have we identified the
...
\begin{frame}{Processes and generation resources}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.36\textwidth}
      \centering\resizebox{!}{38mm}{\input{figures/hierarchy.tex}}\\[1mm]
      {\footnotesize $*$ not exhaustive}
    \end{column}
    \begin{column}{0.60\textwidth}
      \vspace{4mm}
      {\small\input{figures/hierarchy-key.tex}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Processes and optimal prediction}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.36\textwidth}
      \centering\resizebox{!}{42mm}{\input{figures/hierarchy_green.tex}}\\[1mm]
      {\footnotesize $*$ not exhaustive}
    \end{column}
    \begin{column}{0.60\textwidth}
      \vspace{4mm}
...
\begin{frame}{The research frontier}
  ...
  \begin{center}\resizebox{!}{53mm}{\input{figures/pareto.tex}}\end{center}
\end{frame}
...
\begin{frame}{The research frontier}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.49\textwidth}
      \centering\resizebox{!}{51mm}{\input{figures/pareto.tex}}
    \end{column}
...
\begin{frame}{Scope: what will we tackle today?}
  ...
  \begin{center}\resizebox{!}{53mm}{\input{figures/scope.tex}}\end{center}
\end{frame}
