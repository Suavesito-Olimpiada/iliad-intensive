...
\begin{frame}{Sufficient statistics}
  ...
  \vspace{6mm}
  {\centering\input{figures/sufficient-not-minimal.tex}\par}
...
\begin{frame}{Minimal sufficient statistics}
  ...
  \vspace{3mm}
  {\centering\input{figures/minimal-summary.tex}\par}
  \vspace{2mm}
...
\begin{frame}{Sufficient statistics as partitions}
  ...
  \vspace{4mm}
  {\centering\input{figures/sufficient-partitions.tex}\par}
...
\begin{frame}
  ...
  \vspace{4mm}
  {\centering\input{figures/causal-states-intuition.tex}\par}
  ...
  \only<1>{%
    ...
    {\centering
      \resizebox{0.45\textwidth}{!}{%
        \input{figures/transformer-undressed.tex}}
      \par}
    \vfill
  }
  ...
  \only<2>{%
    ...
    {\centering
      \resizebox{0.77\textwidth}{!}{%
        \input{figures/transformer-recurrent-update.tex}}
      \par}
